...
<body>
	...
	<div class="container">
		...
		<button class="btn btn" onclick="update()">정보수정</button>
		<button class="btn btn" onclick="updateFile()">파일수정</button>
		<button class="btn btn" onclick="del()">삭제하기</button>
		<button class="btn btn" onclick="filedown()">다운로드</button>
		<button class="btn btn" onclick="list()">목록으로</button>
	</div>
</body>
</html>
